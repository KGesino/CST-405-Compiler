...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_func_list = 25,                 /* func_list  */
  ...
  YYSYMBOL_arr_decl = 34,                  /* arr_decl  */
  YYSYMBOL_arr2d_decl = 35,                /* arr2d_decl  */
  YYSYMBOL_assign = 36,                    /* assign  */
  YYSYMBOL_arr_assign = 37,                /* arr_assign  */
  YYSYMBOL_arr2d_assign = 38,              /* arr2d_assign  */
...
{
       0,    61,    61,    65,    66,    73,    77,    84,    85,    92,
      93,    97,   104,   105,   112,   113,   114,   115,   116,   117,
     118,   119,   126,   127,   131,   136,   141,   151,   156,   162,
     170,   171,   178,   179,   180,   181,   182,   183,   184,   185,
     189,   190,   197
};
#endif
...
yysymbol_name (yysymbol_kind_t yysymbol)
{
  ...
  {
  "end of file", "error", "invalid token", "NUM", "ID", "INT", "PRINT",
  "RETURN", "VOID", "IF", "ELSE", "WHILE", "'+'", "'-'", "'('", "')'",
  "'{'", "'}'", "','", "';'", "'['", "']'", "'='", "$accept", "program",
  "func_list", "func_decl", "type", "param_list", "param", "stmt_list",
  "stmt", "id_list", "decl", "arr_decl", "arr2d_decl", "assign",
...
{
       0,   -36,   -36,    56,     0,   -36,    22,   -36,   -36,    44,
      23,    77,    78,    28,   -36,    70,   -36,    79,     0,    17,
      88,    46,     3,     6,   -36,   -36,   -36,   -36,   -36,   -36,
     -36,   -36,   -36,    70,   -36,    81,    81,    74,    68,    81,
     -36,   -11,   -36,    42,   -36,   -36,    10,    21,    50,    69,
      92,   -36,    66,    26,    81,    81,    81,   -36,   -36,    48,
     -36,    80,   -36,    83,   -36,    76,    65,    32,   -36,   -36,
      81,    81,    71,   -36,   -36,    81,    84,    36,    52,   -36,
      94,    76,    81,    85,   -36,    82,    38,    81,    86,   -36,
      54,   -36,   -36
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     0,     0,     0,    12,    14,    17,    19,    15,    18,
      20,    21,    16,     0,    10,     0,     0,    22,     0,     0,
      32,    33,    31,     0,     6,    13,     0,     0,     0,     0,
       0,    24,     0,     0,     0,     0,     0,    30,     5,     0,
      27,     0,    23,     0,    39,    40,     0,     0,    36,    37,
       0,     0,     0,    42,    38,     0,    34,     0,     0,    25,
       0,    41,     0,     0,    28,     0,     0,     0,     0,    35,
       0,    26,    29
};
...
{
       0,     3,     4,     5,     6,    13,    14,    23,    24,    38,
      25,    26,    27,    28,    29,    30,    31,    43,    66,    32
};
...
{
      47,    48,    45,    53,    52,     1,    40,    41,     2,    54,
      19,    20,    21,    22,    19,    20,    21,    22,    65,    67,
      68,    69,    42,    44,    12,    45,     9,    58,     1,    40,
      41,     2,    12,    55,    56,    77,    78,    35,    11,    36,
      81,    64,    59,    17,    55,    56,    18,    86,    55,    56,
      55,    56,    90,    76,    55,    56,     7,    83,    10,    89,
      39,    57,    55,    56,    55,    56,    55,    56,    70,    60,
      71,    84,    61,    92,    19,    20,    21,    22,    55,    56,
      74,    63,    16,    75,    40,    41,    50,    51,    55,    56,
      79,    80,    37,    15,    49,    33,    62,    85,     0,     8,
      46,    72,    73,    88,    82,    91,     0,    87,    34
};

static const yytype_int8 yycheck[] =
{
      35,    36,    23,    14,    39,     5,     3,     4,     8,    20,
       4,     5,     6,     7,     4,     5,     6,     7,    53,    54,
      55,    56,    19,    17,    10,    46,     4,    17,     5,     3,
       4,     8,    18,    12,    13,    70,    71,    20,    15,    22,
      75,    15,    21,    15,    12,    13,    18,    82,    12,    13,
      12,    13,    87,    21,    12,    13,     0,    21,    14,    21,
      14,    19,    12,    13,    12,    13,    12,    13,    20,    19,
      22,    19,     3,    19,     4,     5,     6,     7,    12,    13,
      15,    15,     4,    18,     3,     4,    18,    19,    12,    13,
      19,    20,     4,    16,    20,    16,     4,     3,    -1,     4,
      33,    21,    19,    21,    20,    19,    -1,    22,    18
};
...
{
       0,     5,     8,    24,    25,    26,    27,     0,    26,     4,
      14,    15,    27,    28,    29,    16,     4,    15,    18,     4,
       5,     6,     7,    30,    31,    33,    34,    35,    36,    37,
      38,    39,    42,    16,    29,    20,    22,     4,    32,    14,
       3,     4,    19,    40,    17,    31,    30,    40,    40,    20,
      18,    19,    40,    14,    20,    12,    13,    19,    17,    21,
      19,     3,     4,    15,    15,    40,    41,    40,    40,    40,
      20,    22,    21,    19,    15,    18,    21,    40,    40,    19,
      20,    40,    20,    21,    19,     3,    40,    22,    21,    21,
      40,    19,    19
};
...
#line 1590 "parser.tab.c"
  ...
  case 24: /* decl: INT id_list ';'  */
#line 131 "parser.y"
                            { (yyval.node) = (yyvsp[-1].node); }
#line 1596 "parser.tab.c"
    break;

  case 25: /* arr_decl: INT ID '[' NUM ']' ';'  */
#line 136 "parser.y"
                            { (yyval.node) = createArrayDecl((yyvsp[-4].str), (yyvsp[-2].num)); free((yyvsp[-4].str)); }
#line 1602 "parser.tab.c"
    break;

  case 26: /* arr2d_decl: INT ID '[' NUM ']' '[' NUM ']' ';'  */
#line 141 "parser.y"
                                       {
